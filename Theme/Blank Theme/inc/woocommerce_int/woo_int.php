...
function woo_mini_cart_int(){
	global $woocommerce; ?>
	<a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'cptdev'); ?>">
	<?php
	echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'cptdev'), $woocommerce->cart->cart_contents_count);
	?>
	</a>
<?php
}
